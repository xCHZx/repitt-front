...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'auth-recuperar-contrasena-token': RouteRecordInfo<'auth-recuperar-contrasena-token', '/auth/recuperar-contrasena/:token', { token: ParamValue<true> }, { token: ParamValue<false> }>,
