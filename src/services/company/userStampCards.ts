...
const getUserStampCardReadyToRedeemAsCurrentCompany = async (payload: any) => {
  return await authAxios.post(`${baseUrl}/waiting-redeem`, payload)
    .then(response => {
      // console.log('get UserStampCard Ready To Redeem As CurrentCompany', response.data.data)
